...
bool EC::tipCellTest(void){
    ...
    if((VEGFR3tot>(float)VEGFR3norm/2.0f)&&(VEGFR2tot>(float)VEGFR2norm/2.0f)&&(actinUsed>=257.0))return(true);
    else return(false);
...
void EC::GRN(void){
    ...
    affR2R2DLL4 = 0.0;
    affR2R3DLL4 = 1.0; //LC// 0.1-0.8
    //LC - VEGFR2toVEGFR3// affR2R3DLL4 = 0.0; //LC// 0.1-0.8
    //LC - VEGFR2toVEGFR3// affR3R3DLL4 = 1.0; //LC// 0.0 ou 0.01
    affR3R3DLL4 = 0.0;
